...
//         <h2 className="text-3xl font-bold text-center mb-12">Trusted by marketing leaders</h2>
...
//   const adjustedIndex = Math.min(currentIndex, testimonials.length - visibleCount);
...
//             Don't just take our word for it here what our customers say about ADmyBRAND AI Suite.
//           </p>
//         </div>
...
//             {[...Array(testimonials.length - visibleCount + 1)].map((_, index) => (
//               <button
//                 key={index}
